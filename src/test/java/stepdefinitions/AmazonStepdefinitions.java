...
public class AmazonStepdefinitions {
  ...
  // }
    ...
    public void aramaKutusunaIPhoneYazarVeEnterTusunaBasar() {
    ...
    public void sonuclarinIphoneIcerdiginiTestEder() {
        ...
        String actualUrunIsmi= amazonPage.aramaSonucElementi.getText();
        Assert.assertTrue(actualUrunIsmi.contains(expectedIcerik));

    }

    @And("arama kutusuna {string} yazar ve enter tusuna basar")
    public void aramaKutusunaYazarVeEnterTusunaBasar(String arananKelime) {
